...
export async function InboundDeliveryForm() {
  ...
  return (
    <form action={createInboundDeliveryNoteAction} className="space-y-6 rounded-[8px] border border-border bg-card p-5">
      ...
      <fieldset className="grid gap-4 rounded-[8px] border border-border p-4 lg:grid-cols-3">
        <legend className="px-1 text-sm font-semibold">PDF allegato opzionale</legend>
        <input className="focus-ring h-10 rounded-[8px] border border-input bg-background px-3" name="attachmentName" placeholder="Nome documento" />
        <input className="focus-ring h-10 rounded-[8px] border border-input bg-background px-3" name="attachmentDriveFileId" placeholder="Google Drive file id" />
        <input className="focus-ring h-10 rounded-[8px] border border-input bg-background px-3" name="attachmentUrl" placeholder="Link apertura" type="url" />
      </fieldset>
